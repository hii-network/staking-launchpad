...
export const TESTNET_LAUNCHPAD_NAME     = process.env.REACT_APP_TESTNET_LAUNCHPAD_NAME || 'Hii';

// private vars (or derived from)
export const INFURA_PROJECT_ID          = process.env.REACT_APP_INFURA_PROJECT_ID  || '';
export const ENABLE_RPC_FEATURES        = Boolean(INFURA_PROJECT_ID && INFURA_PROJECT_ID !== '');
export const RPC_URL                    = process.env.REACT_APP_RPC_URL ||  (`https://${IS_MAINNET ? "mainnet" : "hii"}.infura.io/v3/${INFURA_PROJECT_ID}`);
...
let elExplorerURL                       = 'https://hii.etherscan.io';
...
export const FAUCET_URL                 = process.env.REACT_APP_FAUCET_URL || 'https://hii-faucet.pk910.de/'
